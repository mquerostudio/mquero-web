                  ...
                  <div className="md:w-2/3 p-6">
                    ...
                    {project.tagNames && project.tagNames.length > 0 && (
                      <div className="flex flex-wrap gap-2 mb-3">
                        {project.tagNames.map((tag, index) => (
                          <span
                            key={index}
                            className={`text-xs font-semibold ${resolvedTheme === 'dark'
                    ...
                    <Link
                      ...
                      className={`${resolvedTheme === 'dark'
                        ...
                        } text-white hover:text-gray-800 px-6 py-2 rounded-md inline-flex items-center gap-2 transition-colors`}
                    >
                      {t('viewProject')}
                      <svg
