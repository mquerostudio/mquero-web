...
export function HeroSection({ data }: { readonly data: HeroSectionProps }) {
    ...
    const highlightedHeading = heading.replace(/(Manuel Quero|electrónica, programar y fabricar cosas|electronics, programming and making things)/g, '<span style="color: #ffaa00ff;">$1</span>');
    ...
    return (
        <header className="py-12">
            <div className="max-w-[1348px] w-full flex flex-col lg:flex-row justify-between items-center mx-auto space-y-4 lg:space-y-0 lg:space-x-6 h-auto border-4 border-gray-300 rounded-3xl p-4 sm:p-8 bg-white">
                ...
                <div className="sm:rounded-[80px] rounded-[40px] overflow-hidden h-32 w-32 sm:h-64 sm:w-64 relative">
                    <StrapiImage
                        src={image.url}
